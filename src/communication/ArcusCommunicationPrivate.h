...
public:
    ...
    /*
     * \brief How often we've sliced so far during this run of PicasoXCore.
     *
     * This is currently used to limit the number of slices per run to 1,
     * because PicasoXCore produced different output for each slice. The fix was
     * to restart PicasoXCore every time you make a slice.
     *
     ...
     */
    size_t slice_count; //!< How often we've sliced so far during this run of PicasoXCore.
