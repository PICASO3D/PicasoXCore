...
GCodePathConfig::GCodePathConfig(const PrintFeatureType& type, const PathConfigFeature& feature, const coord_t line_width, const coord_t layer_height, const Ratio& flow, const GCodePathConfig::SpeedDerivatives speed_derivatives, const bool is_bridge_path, const double fan_speed)
: type(type)
, feature(feature)
