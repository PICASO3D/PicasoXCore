...
public:
    ...
    Polygons support_above_bottom; //!< Piece of support below the support and above the model. This must not overlap with any of the support_infill_parts or support_roof.
    ...
    Polygons support_under_roof; //!< Piece of support above the support roof and below the model. This must not overlap with any of the support_infill_parts or support_bottom.
...
public:
    ...
    std::vector<Polygons> model_on_support_areas; //!< For each layer the model on support areas
