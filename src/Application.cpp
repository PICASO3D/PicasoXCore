...
Application::Application()
{
    ...
    auto env_val = spdlog::details::os::getenv("PICASO_XCORE_LOG_LEVEL");
    if (! env_val.empty())
    {
...
void Application::printHelp() const
{
    fmt::print("\n");
    fmt::print("usage:\n");
    fmt::print("PicasoXCore help\n");
    fmt::print("\tShow this help message\n");
    fmt::print("\n");
#ifdef ARCUS
    fmt::print("PicasoXCore connect <host>[:<port>] [-j <settings.def.json>]\n");
    ...
    fmt::print("\n");
#endif //ARCUS
    fmt::print("PicasoXCore slice [-v] [-p] [-j <settings.json>] [-s <settingkey>=<value>] [-g] [-e<extruder_nr>] [-o <output.gcode>] [-l <model.stl>] [--next]\n");
    fmt::print("  -v\n\tIncrease the verbose level (show log messages).\n");
#ifdef _OPENMP
    ...
    fmt::print("PicasoXCore slice [general settings] \n\t-g [current group settings] \n\t-e0 [extruder train 0 settings] \n\t-l obj_inheriting_from_last_extruder_train.stl [object settings] \n\t--next [next group settings]\n\t... etc.\n");
    fmt::print("\n");
...
{
    fmt::print("\n");
    fmt::print("PicasoXCore\n");
    fmt::print("Copyright (C) 2022 Ultimaker\n");
    fmt::print("Copyright (c) 2022 PICASO 3D\n");
    fmt::print("\n");
    ...
    fmt::print("along with this program.  If not, see <https://www.gnu.org/licenses/>.\n");
}
