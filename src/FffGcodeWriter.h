...
private:
    ...
    */
     ...
     * \return Whether any support skin was added to the layer plan.
     */
    bool addSupportUnderRoofsToGCode(const SliceDataStorage& storage, LayerPlan& gcodeLayer) const;
     ...
     * \return Whether any support skin was added to the layer plan.
     */
    bool addSupportAboveBottomsToGCode(const SliceDataStorage& storage, LayerPlan& gcodeLayer) const;
...
public:
     ...
     */
    void setExtruder_picaso(const SliceDataStorage& storage, LayerPlan& gcode_layer, const size_t extruder_nr) const;
    /*!
     * Change to a new extruder, and add the prime tower instructions if the new extruder is different from the last.
     * 
     * On layer 0 this function adds the skirt for the nozzle it switches to, instead of the prime tower.
