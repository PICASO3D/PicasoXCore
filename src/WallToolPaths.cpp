...
WallToolPaths::WallToolPaths(const Polygons& outline, const coord_t nominal_bead_width, const size_t inset_count, const coord_t wall_0_inset,
    ...
    , bead_width_1(nominal_bead_width)
...
WallToolPaths::WallToolPaths(const Polygons& outline, const coord_t bead_width_0, const coord_t bead_width_1,const coord_t bead_width_x,
                             const size_t inset_count, const coord_t wall_0_inset, const Settings& settings)
    : outline(outline)
    , bead_width_0(bead_width_0)
    , bead_width_1(bead_width_1)
...
{
    const EGCodeFlavor flavor = settings.get<EGCodeFlavor>("machine_gcode_flavor"); // PicasoAddon
    ...
    const auto beading_strat = flavor == EGCodeFlavor::PICASO 
        ? BeadingStrategyFactory::makePicasoStrategy
        (
            bead_width_0,
            bead_width_1,
            bead_width_x,
        ...
        : BeadingStrategyFactory::makeStrategy
        (
            bead_width_0,
            bead_width_x,
            wall_transition_length,
