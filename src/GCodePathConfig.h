...
public:
    ...
    const PathConfigFeature feature; //!< PathConfigFeature
...
public:
    GCodePathConfig(const PrintFeatureType& type, const PathConfigFeature& feature, const coord_t line_width, const coord_t layer_height, const Ratio& flow, const SpeedDerivatives speed_derivatives, const bool is_bridge_path = false, const double fan_speed = FAN_SPEED_DEFAULT);
