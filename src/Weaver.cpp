...
{   
    ...
    log("Chainifying layers...\n");
    {
        ...
        {
            Progress::messageProgress(Progress::Stage::INSET_SKIN, layer_idx+1, layer_count); // abuse the progress system of the normal mode of PicasoXCore
    ...
    log("Finding horizontal parts...\n");
    {
        ...
        {
            Progress::messageProgress(Progress::Stage::SUPPORT, layer_idx+1, wireFrame.layers.size()); // abuse the progress system of the normal mode of PicasoXCore
