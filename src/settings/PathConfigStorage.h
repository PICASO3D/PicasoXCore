...
private:
    ...
    const size_t support_under_roof_extruder_nr;
	...
	const ExtruderTrain& support_under_roof_train;
	const ExtruderTrain& support_above_bottom_train;
...
public:
    ...
    public:
		...
		GCodePathConfig inset1_config;
        GCodePathConfig insetX_config;
        GCodePathConfig bridge_inset0_config;
		GCodePathConfig bridge_inset1_config;
    ...
    GCodePathConfig support_under_roof_config; //!< The config used to print the dense roofs of support.
    GCodePathConfig support_above_bottom_config; //!< The config to use to print the dense bottoms of support
