...
public:
     ...
     */
    std::vector<bool> getPlannedExtruders() const; // PicasoAddon
    /*!
     * Get Count Planned Extruders
     */
    size_t getCountPlannedExtruders() const; // PicasoAddon
    ...
    */
     ...
     */
    void addWall(ConstPolygonRef wall,
                 int start_idx,
    ...
    const GCodePathConfig& getSeamCrossConfig(const ExtrusionJunction& point,
                                              const GCodePathConfig& non_bridge_config,
                                              const GCodePathConfig& inset_0_seam_cross_start_config,
                                              const GCodePathConfig& inset_0_seam_cross_finish_config);
     ...
     */
    void addWall(const ExtrusionLine& wall,
                 int start_idx,
                 const Settings& settings,
                 const GCodePathConfig& non_bridge_config,
                 const GCodePathConfig& bridge_config,
