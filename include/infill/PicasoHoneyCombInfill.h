...
namespace cura
{
	...
	public:
		...
		static void generateHoneyCombInfill(Polygons& result_lines, coord_t infill_line_width, coord_t line_distance, const Polygons& in_outline, coord_t z, int layer_nr, bool simple, AngleDegrees fill_angle);
