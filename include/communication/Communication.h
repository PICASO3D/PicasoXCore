...
class PicasoExtruderStats
{
  public:
    ...
    PicasoExtruderStats() : extruder_nr(0), is_used(false), nozzle_size(0), filament_volume(0), durations(0)
    {
    }
};
...
class PicasoPrintTaskStats
{
  public:
    ...
    PicasoPrintTaskStats()
      : task_id(""), extruder_used_count(0), extruder_total_count(0), extruder_start(0), layer_height(0), first_layer_height(0),
        extruder_stats()
    {
    }
};
 ...
 * communicating instructions from and to PicasoXCore.
 */
class Communication
{
public:
