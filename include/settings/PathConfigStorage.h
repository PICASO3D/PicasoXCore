...
private:
    ...
    const size_t support_roof_extruder_nr; // PicasoAddon
    const size_t support_under_roof_extruder_nr; // PicasoAddon
    const size_t support_above_bottom_extruder_nr;
    ...
    ExtruderTrain& support_under_roof_train; // PicasoAddon
    ExtruderTrain& support_above_bottom_train; // PicasoAddon
...
public:
    ...
    public:
        ...
        GCodePathConfig inset1_config; // PicasoAddon
        GCodePathConfig insetX_config;
        GCodePathConfig bridge_inset0_config;
        GCodePathConfig bridge_inset1_config; // PicasoAddon
        ...
        GCodePathConfig flooring_config; // PicasoAddon
        std::vector<GCodePathConfig> infill_config;
        GCodePathConfig ironing_config;
        GCodePathConfig inset0_config_seam_cross_start; // PicasoAddon
        GCodePathConfig inset0_config_seam_cross_finish; // PicasoAddon
        //GCodePathConfig inset1_config_seam_cross_start; // PicasoAddon
        //GCodePathConfig inset1_config_seam_cross_finish; // PicasoAddon
    ...
    GCodePathConfig support_under_roof_config; // PicasoAddon
    GCodePathConfig support_above_bottom_config; // PicasoAddon
