...
protected:
    ...
    const size_t roofing_layer_count; // PicasoAddon
    const size_t flooring_layer_count; // PicasoAddon
    //size_t wall_line_count; //!< The number of walls, i.e. the number of the wall from which to offset.
    //coord_t roofing_line_width; // PicasoAddon
    //coord_t skin_line_width; //!< The line width of the skin.
    //coord_t flooring_line_width; // PicasoAddon
    const size_t roofing_inset_count;
    //const size_t skin_inset_count; //!< The number of perimeters to surround the skin
    const size_t flooring_inset_count;
    ...
    const EModelSkinMode model_skin_mode; // PicasoAddon
