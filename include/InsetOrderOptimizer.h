...
public:
    ...
    // PicasoAddon
    static std::unordered_set<std::pair<const ExtrusionLine*, const ExtrusionLine*>> getOrder10In_InsetOrder(const std::vector<const ExtrusionLine*>& input);
    static std::unordered_set<std::pair<const ExtrusionLine*, const ExtrusionLine*>> getOrder10In_GridOrder(const std::vector<const ExtrusionLine*>& input);
