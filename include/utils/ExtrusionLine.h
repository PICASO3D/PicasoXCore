...
struct ExtrusionLine
{
    ...
    // PicasoAddon: override seam start index
    int seam_idx;
    ...
    // PicasoAddon: un-link last point
    bool unlink_last_point;
    ...
    , seam_idx(other.seam_idx)
    , unlink_last_point(other.unlink_last_point)
    {}
