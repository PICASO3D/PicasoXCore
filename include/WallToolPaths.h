...
#ifndef WALLTOOLPATHS_H
#define WALLTOOLPATHS_H
...
public:
     ...
     * \param settings The settings as provided by the user
     */
    WallToolPaths(const Polygons& outline, const coord_t bead_width_0, const coord_t bead_width_1, const coord_t bead_width_x, const size_t inset_count, const coord_t wall_0_inset, const Settings& settings);
...
private:
    ...
    coord_t bead_width_1; // PicasoAddon
