...
public:
    ...
    //Polygons roof_outline; // PicasoAddon
    //Polygons skin_outline; // PicasoAddon
    //Polygons floor_outline; // PicasoAddon
    //std::vector<Polygons> roof_insets; // PicasoAddon
    //std::vector<Polygons> skin_insets; // PicasoAddon
    //std::vector<Polygons> floor_insets; // PicasoAddon
    Polygons roof_inner_infill; // PicasoAddon
    Polygons skin_inner_infill; // PicasoAddon
    Polygons floor_inner_infill; // PicasoAddon
};
...
public:
    ...
    Polygons support_above_bottom; // PicasoAddon
    ...
    Polygons support_under_roof; // PicasoAddon
...
public:
    ...
    std::vector<AngleDegrees> support_under_roof_angles; // PicasoAddon
    std::vector<AngleDegrees> support_above_bottom_angles; // PicasoAddon
...
public:
    ...
    std::vector<AngleDegrees> flooring_angles; // PicasoAddon
    ...
    std::vector<Polygons> unsupported_areas; // PicasoAddon
    std::vector<Polygons> model_on_support_areas; // PicasoAddon
